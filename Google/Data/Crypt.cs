...
namespace ThirdPartySignOn.Google.Data
{
    public static class Crypt
    {
        ...
        public static string FromBase64(string inString)
        {
            ...
            {
                ThirdPartySignOnLog.LogOriginMsgEx($"Base64.FromBase64", "need to trim error chars \"{error}\", " +
    ...
    public class DES3
    {
        static string SecretKey =>
               ...
               Convert.ToBase64String(Encoding.UTF8.GetBytes(
                (!string.IsNullOrEmpty(SettingsKeyReader.ServerHostName) ?
                    SettingsKeyReader.ServerHostName : Environment.MachineName))).Substring(0, 16);
#endif
...
#else
            !string.IsNullOrEmpty(SettingsKeyReader.ServerHostName) ?
                    SettingsKeyReader.ServerHostName : Environment.MachineName
#endif
        ));
