...
namespace Saml2AuthGateway.Services
{
    public static class Crypt
    {
        ...
        /// <summary>
        /// Encrypt encrypts <see cref="string">plain</see> with 1x AES, then 3 x 3-DES
        /// </summary>
        ...
        public static string Encrypt(string plain)
        {
            ...
            string cryptText = cryptBytes.ToHex();
        ...
        /// <summary>
        /// Decrypt decrypts encrypted text with 3 x 3-DES, then 1 x AES
        /// </summary>
        /// <param name="crypt"><see cref="string">encrypted text</see></param>
        ...
        public static string Decrypt(string crypt)
        {
            ...
            byte[] cryptBytes = crypt.HexToBytes();
            DES3 des3 = new DES3();
    ...
    public static class CryptExtensions
    {
        ...
        /// encrypts plain with 1x AES, then 3 x 3-DES
        /// </summary>
        /// <param name="plain"><see cref="string">plain text</see></param>
        /// <returns><see cref="string">encrypted string</see></returns>
        ...
        /// <summary>
        /// Extension method for <see cref="string"/>
        /// decrypts encrypted text with 3 x 3-DES, then 1 x AES
        /// </summary>
    ...
    public class DES3
    {
        ...
        private static readonly string DES3_IV = "AMDAMDES";
